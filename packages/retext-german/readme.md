...
**[retext][]** plugin to add support for parsing German natural language.
...
- [retext-english](#retext-english)
  ...
  - [Use](#use)
  - [API](#api)
    - [`unified().use(retextGerman)`](#unifieduseretextgerman)
...
German natural language as input and turn it into a syntax tree.
...
This plugin adds support to unified for parsing German.
If the prose is not German, use [`retext`][retext-core] for any Latin-script
text, or for Dutch use `unified` itself with
[`retext-dutch`][retext-dutch] and [`retext-stringify`][retext-stringify].

If you just want the syntax tree, you can use [`parse-german`][parse-german]
directly.
...
```sh
npm install retext-german
```

In Deno with [`esm.sh`][esmsh]:

```js
import retextGerman from 'https://esm.sh/retext-german@5'
```
...
```html
<script type="module">
  import retextEnglisch from 'https://esm.sh/retext-german@5?bundle'
</script>
```
...
```js
import retextGerman from 'retext-german'
...
The default export is [`retextGerman`][api-retext-german].

### `unified().use(retextGerman)`
...
Node.
This means we try to keep the current release line, `retext-german@^5`,
...
[downloads-badge]: https://img.shields.io/npm/dm/retext-german.svg

[downloads]: https://www.npmjs.com/package/retext-german

[size-badge]: https://img.shields.io/bundlephobia/minzip/retext-german.svg

[size]: https://bundlephobia.com/result?p=retext-german
...
[parse-german]: https://github.com/nyxb/parse-german
...
[api-retext-german]: #unifieduseretextgerman
